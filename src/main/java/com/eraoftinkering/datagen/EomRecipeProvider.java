...
public class EomRecipeProvider extends RecipeProvider implements IToolRecipeHelper {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        toolBuilding(consumer, Items.WIRECUTTER, toolFolder);

        partRecipes(consumer, Items.WRENCH_HEAD, Items.WRENCH_HEAD_CAST, 3, partFolder, castFolder);
        partRecipes(consumer, Items.KNIFE_HEAD, Items.KNIFE_HEAD_CAST, 2, partFolder, castFolder);
        partRecipes(consumer, Items.WIRECUTTER_HEAD, Items.WIRECUTTER_HEAD_CAST, 3, partFolder, castFolder);
    }
