...
public class EomItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        tag(TinkerTags.Items.MODIFIABLE).add(Items.SAW.get());
        tag(TinkerTags.Items.DURABILITY).add(Items.SAW.get());
        tag(TinkerTags.Items.MULTIPART_TOOL).add(Items.SAW.get());
        tag(TinkerTags.Items.MELEE).add(Items.SAW.get());
        tag(TinkerTags.Items.HELD).add(Items.SAW.get());
        tag(TinkerTags.Items.HARVEST).add(Items.SAW.get());
    }
}
